...
parser.add_argument('--upscale_factor',type=int,required=True, help="Super resolution upsampling")
parser.add_argument('--batch_size',type=int,default=64,help='Training BAtch Size')
parser.add_argument('--testBatchSize',type=int,default=10,help="Test Batch Size")
